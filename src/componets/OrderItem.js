  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <View style={{
          display: 'flex', flexDirection: 'row', width: '100%', justifyContent: 'space-between', paddingTop: 10,
        }}
        >
        ...
        >
          ...
          >
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <Text style={typeServer['HTTP(S)'] === true ? {
            ...
            <TouchableOpacity
              style={typeServer.SOCKS5 === false
                ? { marginLeft: 10 } : { marginLeft: 10, backgroundColor: 'rgba(51, 51, 51, 0.5)', borderRadius: 50 }}
              ...
              activeOpacity={0.8}
            >
              <Text style={typeServer.SOCKS5 === true ? {
                color: 'white', paddingTop: 10, paddingBottom: 10, paddingLeft: 14, paddingRight: 14, fontSize: 12, fontWeight: '600',
              } : {
                color: '#CBCBCB', paddingTop: 10, paddingBottom: 10, paddingLeft: 14, paddingRight: 14, fontSize: 12, fontWeight: '600',
              }}
