    ...
    <View style={styles.container}>
      <View style={styles.mainContainer}>
        <View style={{ display: 'flex', flexDirection: 'row' }}>
          <View style={{ top: 13, marginLeft: 10 }}>
            {proxy.flag}
          </View>
        ...
        <View style={{ display: 'flex', flexDirection: 'row' }}>
          ...
          {selected === proxy.id ? (
            <TouchableOpacity onPress={() => { setSelected(null); handleClosePress(); }}>
              <LightRadioUncheked style={{ marginLeft: 9, bottom: 3 }} />
            </TouchableOpacity>
          ) : (
            <TouchableOpacity onPress={() => { setSelected(proxy.id); handleClosePress(); }}>
