...
const FlagTf = props => (
  <Svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 640 480" {...props}>
    ...
    />
    <Use width="100%" height="100%" x={416} y={362} transform="scale(1.2)" xlinkHref="#a" />
    <Use width="100%" height="100%" x={371} y={328} transform="scale(1.2)" xlinkHref="#a" />
    <Use width="100%" height="100%" x={461} y={328} transform="scale(1.2)" xlinkHref="#a" />
    <Use width="100%" height="100%" x={333} y={227} transform="scale(1.2)" xlinkHref="#a" />
    <Use width="100%" height="100%" x={499} y={227} transform="scale(1.2)" xlinkHref="#a" />
  </Svg>
)
