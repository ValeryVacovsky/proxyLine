...
const FlagJe = () => (
  <Svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 30 18">
    <Defs>
      <ClipPath id="a">
        <Path fillOpacity={0.7} d="M-5.3-6h40v30h-40z" />
      </ClipPath>
    </Defs>
    <G clipPath="url(#a)" transform="matrix(.75 0 0 .75 4 2.3)">
      ...
      <G transform="translate(-9.7 -6) scale(.20361)">
        ...
        <G id="b" stroke="#000">
          ...
          />
          <Path strokeWidth={0.1} d="m113 26.5-1-.3m1 .3h-1m1 .1-.9.3m1.7-.4 1-.3m-1 .3h1.2m-1.2.1 1 .3" />
          <Path
            fill="#0051ba"
            strokeWidth={0}
        ...
        <Use width={30} height={18} transform="matrix(.9 0 0 .9 11.6 13.7)" xlinkHref="#b" />
        <Use width={30} height={18} transform="matrix(.67 0 0 .75 39.2 27.5)" xlinkHref="#b" />
      </G>
    </G>
  </Svg>
)
