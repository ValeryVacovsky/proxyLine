...
const FlagCx = () => (
  <Svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 640 480">
    ...
    <G fill="#fff" transform="matrix(.64 0 0 .64 0 80)">
      ...
      <Use width="100%" height="100%" x={2.5} y={269.1} xlinkHref="#a" />
      <Use width="100%" height="100%" x={-112.1} y={123.2} xlinkHref="#a" />
      <Use width="100%" height="100%" x={108.4} y={85} xlinkHref="#a" />
    </G>
  </Svg>
)
