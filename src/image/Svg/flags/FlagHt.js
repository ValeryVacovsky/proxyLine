  ...
  <Svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 640 480">
    ...
    <G fill="#f1b517" stroke="#000" strokeWidth={0.2}>
      ...
      <G transform="translate(-80) scale(1.6)">
        ...
        <Use width="100%" height="100%" transform="matrix(-1 0 0 1 499.9 0)" xlinkHref="#a" />
      </G>
      <G transform="translate(-80) scale(1.6)">
        ...
        <Use width="100%" height="100%" transform="matrix(-1 0 0 1 499.9 0)" xlinkHref="#b" />
      ...
      <G transform="translate(-80) scale(1.6)">
        <Use width="100%" height="100%" transform="matrix(1 0 0 -1 0 320.4)" xlinkHref="#c" />
        <Path
          fill="#016a16"
          stroke="#fff"
          strokeLinecap="round"
        ...
        <Use width="100%" height="100%" transform="matrix(-1 0 0 1 499.9 0)" xlinkHref="#d" />
        <Path
          fill="#0a328c"
          stroke="#0a328c"
