...
const FlagAr = () => (
  <Svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 640 480">
    ...
    <G id="c" transform="translate(-64) scale(.96)">
      ...
      />
      <Use width="100%" height="100%" transform="rotate(22.5 400 250)" xlinkHref="#a" />
      <Use width="100%" height="100%" transform="rotate(45 400 250)" xlinkHref="#a" />
      <Use width="100%" height="100%" transform="rotate(67.5 400 250)" xlinkHref="#a" />
      <Path
        id="b"
        fill="#85340a"
        d="M404.3 274.4c.5 9 5.6 13 4.6 21.3 2.2-6.5-3.1-11.6-2.8-21.2m-7.7-23.8 19.5 42.6-16.3-43.9"
      />
      <Use width="100%" height="100%" transform="rotate(22.5 400 250)" xlinkHref="#b" />
      <Use width="100%" height="100%" transform="rotate(45 400 250)" xlinkHref="#b" />
      <Use width="100%" height="100%" transform="rotate(67.5 400 250)" xlinkHref="#b" />
    </G>
    <Use width="100%" height="100%" transform="rotate(90 320 240)" xlinkHref="#c" />
    <Use width="100%" height="100%" transform="rotate(180 320 240)" xlinkHref="#c" />
    <Use width="100%" height="100%" transform="rotate(-90 320 240)" xlinkHref="#c" />
    ...
    />
    <Use width="100%" height="100%" transform="matrix(-1 0 0 1 640.2 0)" xlinkHref="#d" />
    <Use width="100%" height="100%" transform="matrix(-1 0 0 1 640.2 0)" xlinkHref="#e" />
    <Use width="100%" height="100%" transform="translate(18.1)" xlinkHref="#f" />
    <Use width="100%" height="100%" transform="matrix(-1 0 0 1 640.2 0)" xlinkHref="#g" />
    <Path
      fill="#85340a"
    ...
    />
    <Use width="100%" height="100%" transform="translate(-18.4)" xlinkHref="#h" />
