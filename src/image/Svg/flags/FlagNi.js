...
const FlagNi = props => (
  <Svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 640 480" {...props}>
    ...
    />
    <G clipPath="url(#c)" transform="matrix(.8 0 0 .8 -80 0)">
      <Path fill="#fff" d="m500 226.4-31.5 54.5-15.4 26.7h93.8l-14.7-25.4-32.2-55.8z" />
      <G id="e">
        <G id="d">
          <Path fill="#17c0eb" stroke="#17c0eb" strokeWidth={0.1} d="m500 226.4-2.4 4 2.4 55 2.4-55z" opacity={0.6} />
          <Path fill="#fff" d="M500 277.5h-.1l.1 3 .1-3h-.1z" />
        </G>
        <Use width="100%" height="100%" transform="rotate(72 500 285.5)" xlinkHref="#d" />
        <Use width="100%" height="100%" transform="rotate(144 500 285.5)" xlinkHref="#d" />
        <Use width="100%" height="100%" transform="rotate(-144 500 285.5)" xlinkHref="#d" />
        <Use width="100%" height="100%" transform="rotate(-72 500 285.5)" xlinkHref="#d" />
      </G>
      <Use width="100%" height="100%" transform="rotate(8 500 285.5)" xlinkHref="#e" />
      <Use width="100%" height="100%" transform="rotate(16 500 285.5)" xlinkHref="#e" />
      <Use width="100%" height="100%" transform="rotate(24 500 285.5)" xlinkHref="#e" />
      <Use width="100%" height="100%" transform="rotate(32 500 285.5)" xlinkHref="#e" />
      <Use width="100%" height="100%" transform="rotate(40 500 285.5)" xlinkHref="#e" />
      <Use width="100%" height="100%" transform="rotate(48 500 285.5)" xlinkHref="#e" />
      <Use width="100%" height="100%" transform="rotate(56 500 285.5)" xlinkHref="#e" />
      <Use width="100%" height="100%" transform="rotate(64 500 285.5)" xlinkHref="#e" />
      <Path
        fill="red"
      ...
      <G fill="url(#h)">
        ...
        <G id="o" fill="url(#i)">
          ...
          />
          <Use width="100%" height="100%" y={-1.1} fill="url(#k)" xlinkHref="#l" />
          <Use width="100%" height="100%" y={-2.2} fill="url(#m)" xlinkHref="#l" />
        </G>
        <Use width="100%" height="100%" y={-3.3} fill="url(#n)" xlinkHref="#o" />
        <Use width="100%" height="100%" y={-6.7} fill="url(#p)" xlinkHref="#o" />
        <Path
          fill="url(#q)"
      ...
      <G fill="#ccd11e">
        ...
        <Use width="100%" height="100%" x={-15.3} xlinkHref="#t" />
        <G fill="#c6cb24">
          <Path
            fill="url(#u)"
        ...
        <Use width="100%" height="100%" x={-15.4} fill="#c6cb24" xlinkHref="#w" />
      </G>
      <Path
        fill="#fff"
      ...
      <G id="A">
        ...
        />
        <Use width="100%" height="100%" y={-1.3} xlinkHref="#z" />
        <Use width="100%" height="100%" y={-2.6} xlinkHref="#z" />
      </G>
      <Use width="100%" height="100%" y={-3.9} xlinkHref="#A" />
      <Use width="100%" height="100%" y={-7.7} xlinkHref="#A" />
      <Path
        fill="#97c924"
