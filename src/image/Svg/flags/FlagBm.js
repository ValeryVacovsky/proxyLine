...
const FlagBm = () => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480">
    ...
    <Path fill="#784421" stroke="#000" strokeWidth={0.4} d="m484.9 256 1.8-.5-11.7-40.3-.4.1z" />
    ...
    <Path
      ...
      strokeMiterlimit={2.6}
      strokeWidth={0.5}
      d="m471.5 203.7 4.8 1.6s4.5 2 10.3 0l4.4-1.7-3 4.6v2.4l1.8 2.7s-1.1.5-4.5-1.6c0 0-3.7-2.9-8.1 0 0 0-2.5 1.6-4.5 1.6l2.9-3.2-1.1-2.9-3-3.6z"
    />
    <Path
      fill="#fff"
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={0.4}
      d="m496.7 240.4 1-1.3 2.1-1.7s3.4 8.8 3.5 10.7v2.7s5 1.3 6 9l-4.2 7.7-6.5-3.7-1.9-1.3v-22z"
    />
    ...
    <Path
      ...
      strokeMiterlimit={10}
      strokeWidth={0.4}
      d="m456.6 229.5 5 40.1m-3.8-40.2 5.6 37.4m-4.6-37.6 6.5 37.1"
    />
    <Path fill="#784421" stroke="#000" strokeWidth={0.4} d="m469 263.1 1.8-.6-11.7-40.2h-.4z" />
    <Path
      fill="none"
      stroke="#000"
      strokeMiterlimit={10}
      strokeWidth={0.4}
      d="m462.4 227.7 11.8 29.8m-12.6-29.3 11.4 31"
    />
    <Path
      fill="#fff"
      d="M443 308.5s-1.4-1.3-1.2-3.6c0 0 0-.5-.2-.6 0 0-.3-.1-.3.5 0 0-.4 2.4 1.3 3.8 0 0 .1.2.3.1 0 0 .2 0 0-.2z"
    />
    <Path fill="none" stroke="#000" strokeMiterlimit={10} strokeWidth={0.4} d="m463 227.3 12 27.2M459.7 229l7.5 36.6" />
    <Path
      fill="#f5ce00"
      stroke="#000"
      strokeMiterlimit={2.6}
      strokeWidth={0.5}
      d="M520.5 256c-5.3-3-6.5-9.6-6.5-9.6a20.6 20.6 0 0 1 1.4-12c3.4-7.2 9.3-8.6 9.3-8.6s-5.8 4-7.4 9.4c0 0-1.2 4.6-.5 9 .7 4.6.4 3.4 1.5 6.9l2.2 5z"
    />
    <Path
      fill="#784421"
      stroke="#000"
      strokeWidth={0.2}
      d="m497.6 239-22.3 7.1-1.2 10c-5.3 7.7-16.1 9-16.1 9l8.4 9 16 3.3 8.5-6.5 7.7-7c-.8-3.8-.4-9.4-.4-9.4 0-1 .4-3.2.4-3.2s-1.3-9-1-12.2z"
    />
    <Path
      fill="none"
      stroke="#000"
    ...
    <Path
      ...
      strokeMiterlimit={10}
      strokeWidth={0.4}
      d="m503.3 250.8-5 3.7s-20.6 9.4-36.3 9.7m36.2-3s-15.8 8.1-24.8 8.2"
    />
    <Path
      fill="#d40000"
      stroke="#000"
    ...
    <Path
      ...
      strokeMiterlimit={2.6}
      strokeWidth={0.4}
      d="M452.4 236s.6-2.5-2.2-6.7c0 0-1.8-3.9-2.7-6.3m6.2-2.7 2 5.5 2.4 5.7"
    />
    <Path
      fill="none"
      stroke="#000"
    ...
    />
    <Path fill="#784421" stroke="#000" strokeWidth={0.4} d="m456 228.8.3.7s5 .2 7.7-3.2l-.3-.7s-4.4-.2-7.6 3.2z" />
    <Path fill="none" stroke="#000" strokeMiterlimit={10} strokeWidth={0.4} d="M474.1 255.6s17.3-5.1 24-8.1" />
    <Path fill="#784421" stroke="#000" strokeWidth={0.2} d="m472.3 223.7-.2-.5 8.5-3.3.2.6z" />
    <Path
      fill="none"
      stroke="#000"
      strokeMiterlimit={10}
      strokeWidth={0.4}
      d="m473 223.4 5.7 27.9m-4.7-28.2 6.5 27.7m-5.4-28.2 7.1 27.6m-4.3-28.6 9.7 20.6m-8.4-21 10.3 20.4m-9.4-20.9 11.2 20.4m-13 10.4 4.4-1.4m-7.7-1.3s12.8-3.8 22.6-7.7m-22.8 9s16.3-4.2 22.8-7.4m-17.8 20.7.8 2.7 2.4-.8-.8-2.6m4.2-1.1.8 2.6 2.3-.8-.8-2.6m-13.4-14.7-.2-3.5 21.4-6.5 1.1 3m-13.4.7 1.1 3.2m6.3-5.4 1.4 3m.4-3.6 1.3 2.8m.4-3.3 1.3 3m0-3.4 2.4-1.3 1 2.6m-2.2-2 1.2 2.8"
    />
    <Path
      fill="none"
      stroke="#00247d"
      strokeMiterlimit={10}
      strokeWidth={0.5}
      d="M444.6 276.2s-4.2-4.3 0-8.4c0 0-4.6-2.2-3.9-5.8m11.4 17.5s-4.4.6-3.1-7.8c0 0-1.8 3.3-2.4 5a3.9 3.9 0 0 0 1.7 4.5c.7.5 4.6 1.5 5.8-1m-6.9-13.6s-1.8 1.6-.5 4.6m2.3-4.2s.2 2.9 1.7 4.5m-.4-5.6s0 3.4 2.4 5.5m-1.2-6.7s0 3.8 2.8 6.2m11.3-.6s1.4-3.2 4.4-3c0 0-1.4.7-1.4 2.1 0 0-.2 2.5 2.4 2.7 0 0 2.1.3 3.2-.9"
    />
    <Path
      fill="none"
      stroke="#00247d"
      strokeMiterlimit={10}
      strokeWidth={0.5}
      d="M472.8 284.6s-7.5-3.5-6.7-8.5c0 0 .3-3 3.3-4.5m-1.6 3.2s-.7 2.1.8 3.6m.9-5.1s-1 2.4.6 4.1m1.2-5.3s-1.1 2 .2 3.8m-7 9.2s4 3.6 7.2 3.6m-8.5-2.4s3.8 3 6.2 3.5m-7.6-2.7s4.7 4.1 7.6 4.4m11.5 3.8s-4.6 2.5-1 5.2m-2-7.9 7.6-3.8m-5.7 5.2s7.6-4.6 9.8-5.6m-5.9 6s6.5-4.4 10-6.3m-5.7 6s4.5-3.4 8.8-6m1.5-4.3s-2.2-3.2-9.4 0c0 0 2.7-2.4 7.9-4.3m7.2-13.7s.6 2.6 0 4.2"
    />
    <Path
      fill="none"
      stroke="#00247d"
    ...
    <Path
      ...
      strokeMiterlimit={2.6}
      strokeWidth={0.4}
      d="M525.5 211.2s.7-1 .4-3.7 2.2-3.1 3.1-2.3c0 0 1 .8 0 2.6a7 7 0 0 1-3.5 3.4z"
    />
    ...
    <Path
      ...
      strokeMiterlimit={2.6}
      strokeWidth={0.4}
      d="M524.8 210.2s-.1-1.2-2-3c-2-2-.4-3.7.8-3.7 0 0 1.2 0 1.7 1.9a7 7 0 0 1-.5 4.8z"
    />
    ...
    <Path
      ...
      strokeMiterlimit={2.6}
      strokeWidth={0.4}
      d="M522.1 209.3s-.5-.9-2.9-1.8c-2.4-.8-1.8-2.9-.8-3.4 0 0 1.1-.4 2.2 1a6.4 6.4 0 0 1 1.5 4.2z"
    />
    ...
    <Path
      ...
      strokeMiterlimit={2.6}
      strokeWidth={0.4}
      d="M523.6 210.2s-1.1.4-3.7-.9c-2.6-1.2-3.7 1-3.2 2 0 0 .4 1.3 2.4 1a7 7 0 0 0 4.5-2z"
    />
    ...
    <Path
      ...
      strokeMiterlimit={2.6}
      strokeWidth={0.4}
      d="M436.8 211.2s-.7-1-.4-3.7c.3-2.8-2.1-3.1-3-2.3 0 0-1 .8-.1 2.6a7 7 0 0 0 3.5 3.4z"
    />
    ...
    <Path
      ...
      strokeMiterlimit={2.6}
      strokeWidth={0.4}
      d="M437.6 210.2s0-1.2 2-3c2-2 .4-3.7-.8-3.7 0 0-1.3 0-1.7 1.9a7 7 0 0 0 .5 4.8z"
    />
    <Path
      fill="#fff"
    ...
    <Path
      ...
      strokeMiterlimit={2.6}
      strokeWidth={0.4}
      d="M440.2 209.3s.5-.9 3-1.8c2.3-.8 1.7-2.9.7-3.4 0 0-1-.4-2.2 1a6.4 6.4 0 0 0-1.5 4.2z"
    />
    ...
    <Path
      ...
      strokeMiterlimit={2.6}
      strokeWidth={0.4}
      d="M438.7 210.2s1.2.4 3.7-.9c2.6-1.2 3.7 1 3.3 2 0 0-.5 1.3-2.5 1a7 7 0 0 1-4.5-2z"
    />
