...
const FlagAi = () => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480">
    ...
    />
    <Path fill="#fff" fillRule="evenodd" d="M510.9 243.6a1.6 1.6 0 1 1-3.3 0 1.6 1.6 0 0 1 3.3 0z" />
    <Path
      fill="#f90"
    ...
    />
    <Path fill="#fff" fillRule="evenodd" d="M460 242.6c.9-.4 1.9-.1 2.3.7a1.6 1.6 0 1 1-2.2-.7z" />
    <Path
      fill="#f90"
    ...
    />
    <Path fill="#fff" fillRule="evenodd" d="M485.5 285.9a1.6 1.6 0 1 1 1.7-2.8 1.6 1.6 0 0 1-1.7 2.8z" />
