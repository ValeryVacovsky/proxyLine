...
const FlagCc = () => (
  <Svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 640 480">
    ...
    <G fill="#ffe000" transform="translate(0 80) scale(.0635)">
      <Use width="100%" height="100%" x={7560} y={4200} xlinkHref="#a" />
      <Use width="100%" height="100%" x={6300} y={2205} xlinkHref="#a" />
      <Use width="100%" height="100%" x={7560} y={840} xlinkHref="#a" />
      <Use width="100%" height="100%" x={8680} y={1869} xlinkHref="#a" />
      <Use width="100%" height="100%" x={8064} y={2730} xlinkHref="#b" />
    </G>
  </Svg>
)
