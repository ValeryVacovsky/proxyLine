...
const FlagHk = () => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480">
    ...
    <G clipPath="url(#a)" transform="translate(83.5) scale(.94)">
      ...
      />
      <Path fill="#ba0000" fillRule="evenodd" stroke="#000" strokeWidth={2.1} d="m306.5 310.1.2.2" />
      ...
      />
      <Path fill="#ba0000" fillRule="evenodd" stroke="#000" strokeWidth={2.1} d="m205.1 325.3-.1.2" />
      ...
      />
      <Path fill="#ba0000" fillRule="evenodd" stroke="#000" strokeWidth={2.1} d="m160.7 235.2-.2-.1" />
