...
const FlagPn = props => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480" {...props}>
    ...
    <G clipPath="url(#a)" transform="translate(320 160) scale(21.33333)">
      <Circle r={20} fill="#00247d" />
      <Path stroke="#fff" strokeWidth={3} d="m-20-10 40 20m-40 0 40-20" />
      <Path stroke="#cf142b" strokeWidth={2} d="m-20-10 40 20m-40 0 40-20" />
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={0.6}
      d="M410 310.4c-11.4 9.6-17.3 33.1-16 49.1.3 4.4 1.5 7.5 3.4 9.3.8-9 7.1-32.4 23.2-42.9 13.6-8.8 34.8-28.6 42.7-51.2a18 18 0 0 0-8.4-9.8c-7.8 21.4-28.7 31.6-45 45.5z"
    />
    <Path
      fill="#316d3a"
      stroke="#000"
      strokeWidth={0.6}
      d="M448.4 254.8c-4 6-13.2 14.4-22 17.8 1.9-2.2 2.5-5 2.6-7.2a80.8 80.8 0 0 1-42.7.5 58.2 58.2 0 0 0 57.7-17.2c2 2.2 3.6 4 4.4 6.1z"
    />
    <Path
      fill="#337321"
      stroke="#000"
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={0.6}
      d="M367.7 186.2a31.4 31.4 0 0 1 4-4.9m41.3 36.4c2.1-1.1 5.3-1.3 8.9-1m-12.1 234c-.8-1.1-1.1-6.2-.6-9.2m7.3 7.8"
    />
    <Path
      fill="#f7e017"
      stroke="#000"
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={0.6}
      d="M482.6 291.1h54.3v64.4c0 54.7-30.5 87.1-61.5 104.3A114.3 114.3 0 0 1 414 355.5V291h38c0 3.4.4 8.4 4.3 13.4 9-1 19.2-7.7 26.2-13.4z"
    />
    <Path fill="#006ec7" stroke="#000" strokeWidth={0.6} d="M536.9 291.1v64.4c0 16.5-2.8 31-7.5 43.6l-54-99-53.9 99" />
    <G fill="#f7e017" stroke="#000" strokeWidth={0.6}>
      <Path d="m500 429.6 5.2 2.6a38.3 38.3 0 0 0 2.4-21c-3 7.9-13.6 7.6-16.4 12.4a34.6 34.6 0 0 1 4.8 3 55 55 0 0 1-16.7 11v-51c0-3.6-1.2-6.6-1.2-9.6v-10.5c0-2.4-.5-5.9-2.7-5.9-2.1 0-2.6 3.5-2.6 5.9V377c0 3-1.2 6.4-1.2 9.6v51c-2.6-7.6-12.9-5-17.6-12.6a13.5 13.5 0 0 1 5.7-.2c-3.5-12.2-13.3-13.1-15.2-16.7 0 5-2.1 16.7 1.2 21.7a13.3 13.3 0 0 1 3.2-2.6c4 8.8 22.3 8.8 26.5 23.3 3.5-5.3 15.9-11.5 24.6-20.9z" />
      ...
      <Path d="M455.7 385.8c1.2 0 2.2-1.8 2.2-4s-1-4-2.2-4m11.7 8.8c1.5 0 2.7-2.1 2.7-4.8 0-2.7-1.2-4.9-2.7-4.9m2.8 10c1.5 0 2.8-2.3 2.8-5.1s-1.3-5.1-2.8-5.1m9.1 10.2c1.6 0 2.8-2.3 2.8-5.1 0-2.9-1.2-5.2-2.8-5.2m3 10.2c1.4 0 2.7-2.3 2.7-5 0-2.8-1.3-5-2.8-5m12.8 9.1c1.2 0 2.2-1.8 2.2-4.1s-1-4.1-2.2-4.1m-46.2 49.5a18.1 18.1 0 0 1 5.2-2.2m43.4 2.6-1.4-1m4 3c3.3-3.5 6-7.6 7.6-12.2" />
    </G>
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={0.6}
      d="M513.3 278.7a12 12 0 0 1 2.4 12.4h-4.5c1.9-5.7.7-11.2-7.4-11.9-12.1-1-26.2 22.4-47.4 25.3-6.2-7.4-5.9-21.5 2-28.1a86.7 86.7 0 0 0-18.6-30.2"
    />
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={0.6}
      d="m439.8 246.2 4.2.8a24.9 24.9 0 0 0 19-3c6-4.3 22.2-17.7 40.6-19.1"
    />
    <Path
      fill="none"
      stroke="#000"
      strokeWidth={0.6}
      d="M435 242c5.8 1.3 17.6 1.8 23.5-2.2a80.4 80.4 0 0 1 40.5-15.6"
    />
    <Path
      fill="#337321"
      stroke="#000"
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={0.6}
      d="M544.7 452.7c1-1.3 1.6-6.9 1-10.3m-8.4 8.4a15.7 15.7 0 0 0 5.1-8.2m-10 4.3c2-.8 6.7-6.5 7.8-10.2m-12.2 3.7a26 26 0 0 0 12.1-9"
    />
    <Path
      fill="#f7e017"
      stroke="#000"
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={0.6}
      d="M462.5 207a36.5 36.5 0 0 0-15.9-17.7l-.2-4a53 53 0 0 0 10.7-8c17.9 8.5 42.2-3.6 53.4-16.3l4.3 2.7-2.2 2.8-2.2-1.2c-2.8 3.4-13 13-16.1 15a61 61 0 0 0 11.4 1.7c10-7.1 17.9-13.6 21.7-14l3.2 4.2-2.9 2-2.2-1.2a114.6 114.6 0 0 0-27.7 41c-6.6-1.5-30.5-.5-35.3-7.1z"
    />
    <Path
      fill="none"
      stroke="#000"
      strokeWidth={0.6}
      d="M463.4 204.3c-1.6-8.9 1-18.7 5.5-21.7a35.6 35.6 0 0 0 36.8-.6"
    />
    <Path
      fill="none"
      stroke="#000"
      strokeWidth={0.6}
      d="M463.4 199.6c7.6-.2 24.2 1.1 28.3 1.7 4 .6 10.8 2.3 9.8 4.3m-34.6-7.2 2.2-2.2-2.2-2.2-2.2 2.2 2.2 2.2z"
    />
    <Path
      fill="#337321"
      stroke="#000"
    ...
    <Path
      ...
      stroke="#000"
      strokeWidth={0.6}
      d="M455 188.3h.9v6.5l.6.3 5.6-3.2.5.9-5.7 3.2a1.7 1.7 0 0 1 0 .6l5.7 3.3-.5.8-5.7-3.2"
    />
    <Path
      fill="#337321"
      stroke="#000"
      strokeWidth={0.6}
      d="M450.7 215c-.7-.8-2-3.1-2-4.8a6.2 6.2 0 0 1 4.1 1.6c-.1-1.2-.6-3.8-.3-5 1.3.5 4 2 5 3.8"
    />
    <Path
      fill="#f7e017"
