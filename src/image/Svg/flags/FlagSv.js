...
const FlagSv = props => (
  <Svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 640 480" {...props}>
    ...
    <G transform="matrix(.8 0 0 .8 -92.7 0)">
      ...
      <G id="a" stroke="#000" strokeMiterlimit={2.6}>
        <Path
          fill="#e60000"
          fillRule="evenodd"
          strokeWidth={0.1}
      ...
      <Use width="100%" height="100%" transform="matrix(-1 0 0 1 1030 0)" xlinkHref="#a" />
      <Path
        fill="#00209f"
        fillRule="evenodd"
    ...
    <G transform="matrix(.8 0 0 .8 -92.7 0)">
      ...
      />
      <G id="b" fill="none" strokeMiterlimit={2.6} strokeWidth={0.2}>
      ...
      <Use width="100%" height="100%" transform="matrix(-1 0 0 1 1030 0)" xlinkHref="#b" />
      <Path
        fill="none"
        stroke="#000"
        strokeMiterlimit={2.6}
      ...
      <Use width="100%" height="100%" transform="matrix(-1 0 0 1 1030 0)" xlinkHref="#c" />
    </G>
    <Path fill="#fc0" stroke="#000" strokeMiterlimit={2.6} strokeWidth={0.3} d="m319.3 197.9-40.2 67.3h80.5z" />
    <Path fill="#fff" stroke="#fff" strokeMiterlimit={2.6} strokeWidth={0.1} d="M319.3 202.3 283 263h72.7z" />
    <Path
      fill="#007e93"
      stroke="#007e93"
      strokeMiterlimit={2.6}
    ...
    <Path fill="none" stroke="#000" strokeMiterlimit={2.6} strokeWidth={0.2} d="M319.3 202.3 283 263h72.7z" />
