...
const FlagTc = props => (
  <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480" {...props}>
    ...
    <G stroke="#000" strokeWidth={0.1}>
      <Path
        fill="#ff9e3d"
        d="M206 52.9a2 2 0 0 0-1.3-.5c.1-1.3-.8-1.8-1.5-2-.7-.3-1-.6-1-1.1-.1-.5-.5-.9-1.1-1-.6-.2-1.2-.8-1.4-1.1-.2-.3-.3-.3-.5.2s-.9 1.5-.2 1.5c-.5.4-.8.8-.5 1.4-.3.3-.5.7-.1.8l.6.4c-.4 0-.5.8.4 1-.2 0-.3.6.1.6-.5 0-1 .8-1.6.8-.7 0-1 .2-1 .5l-.6.8c.5 0 .8 0 1-.2s.7-.3 1 0c.3.2 1 .3 1.2.2-.6.5-1 1-1.1 1.6 0 .6-.5 1.2-1 1.4-.3.2-1 .6-1.1 1.2.5 1.4 1.3 1.7 2.1 2.1 1.4.6 2.3 1.1 2.9 1.8.6.6.8.1 1.7 1.3.9 1 1.7 3.2 2.6 3.5.9.4 2 .2 2.6-1 .7-1 1-12.4-2.2-14.3z"
        transform="matrix(3.909 0 0 3.9094 -339.1 46.6)"
      />
      <Path
        fill="#ff927f"
        d="M207.5 48.1c-.9 1-2 1.8-1.7 3.4s.3 4.2-1.2 5c-1.4 1-2.1 3.2-.4 4.5 1.8 1.3 1.9 2.9 2.1 4.3.3 1.5 1.1 2.7 2.3 1.7 1.2.2 1.8-.3 1.8-1.3s0-1.4 1-1.7c.8-.3 1-.6 1.5-1.4.4-.8.6-1.2.4-1.6a3.7 3.7 0 0 1-.2-2.2c.2-.7-.2-1-.4-1.5a1.9 1.9 0 0 1-.2-1.4c0-.6-.2-1-.6-1.3-.4-.3-.6-.6-.5-1 0-.5-.3-.8-.8-1.2s-.7-.8-.7-1.5-1.4-2.3-2.4-2.8z"
        transform="matrix(3.909 0 0 3.9094 -339.1 46.6)"
      />
      <Path
        fill="#ff9ee1"
    ...
    <G stroke="#000" strokeWidth={0.1}>
      ...
      <Path
        fill="#ef072d"
        d="M217.3 75.3c1.3 0 2.7-.2 3.7-.6 1.1-.4 1.2-.8.8-1.3-.3-.4-.9-.2-1.5.1a11.2 11.2 0 0 1-6 0c-.6-.2-1.2-.5-1.5-.1-.4.5-.4.9.8 1.3 1 .4 2.4.6 3.7.6z"
        transform="matrix(3.909 0 0 3.9094 -339.1 46.6)"
      />
    </G>
    <G fill="#b95a1e" fillRule="evenodd">
      ...
      <Path
        stroke="#000"
        strokeWidth={5.7}
        d="M832.7 113.4s-14.3-53.2-14.3-159.5a355 355 0 0 1 85.7-230.3C910-249 847-152.4 847-46c0 77.5 21.1 195 21.1 195l-35.4-35.5z"
        transform="matrix(.07714 0 0 .06555 495.7 244.7)"
      />
      <Path
        stroke="#000"
      ...
      <Path
        stroke="#fdc301"
        strokeWidth={16.1}
        d="M318.9 1318.1c55-122.3 70.9-336.6 70.9-372 0-99.8-33-585.2-35.5-779.6s124-301.2 248-301.2c106.4 0 177.2 71 177.2 177.2h-53.1a121 121 0 0 0-124-124c-106.3 0-188 83.7-195 248-7.5 190 21.4 683 17.8 815S374 1231.2 318.9 1318z"
