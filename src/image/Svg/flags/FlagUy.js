  ...
  <Svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 640 480" {...props}>
    ...
    <G
      ...
      <G id="c">
        <G id="b">
          <G id="a">
            <Path strokeLinecap="square" d="M1.5 9 6 12c-8 13 1 15-6 21 3-7-3-5-3-17" transform="rotate(22.5)" />
            <Path fill="none" d="M0 11c-2 13 4.5 17 0 22" transform="rotate(22.5)" />
            <Path d="M0 0h6L0 33-6 0h6v33" />
          </G>
          <Use width="100%" height="100%" transform="rotate(45)" xlinkHref="#a" />
        </G>
        <Use width="100%" height="100%" transform="rotate(90)" xlinkHref="#b" />
      </G>
      <Use width="100%" height="100%" transform="scale(-1)" xlinkHref="#c" />
      <Circle r={11} />
    </G>
