  ...
  <Svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 640 480">
    ...
    <G fill="#fff" stroke="#000" transform="matrix(1.2 0 0 1.2 85.6 -522)">
      <G strokeLinejoin="bevel">
        ...
        <Path strokeLinejoin="miter" d="M94.5 669.5a9.3 9.3 0 0 0 4.4-5.3H292a9.3 9.3 0 0 0 4.4 5.3z" />
      </G>
      ...
      <Use width="100%" height="100%" transform="matrix(-1 0 0 1 390.7 0)" xlinkHref="#a" />
