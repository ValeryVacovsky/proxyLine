...
const FlagPt = props => (
  <Svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 640 480" {...props}>
    ...
    <G transform="translate(0 26.7) scale(1.06667)">
      ...
      />
      <G id="e">
        <G id="d" fill="#ff0" stroke="#000" strokeWidth={0.5}>
          ...
          <Use width="100%" height="100%" x={10.6} xlinkHref="#a" />
          <Path id="b" d="M186.3 139h1.2v1h.9v-1h1.2v1h.9v-1h1.2v2c0 .4-.2.6-.5.6h-4.3a.6.6 0 0 1-.6-.6v-2z" />
          <Use width="100%" height="100%" x={10.6} xlinkHref="#b" />
          <Path fill="#000" stroke="none" d="M193.9 140.6c0-.6.9-.6.9 0v1.6h-.9v-1.6" />
          <Path id="c" fill="#000" stroke="none" d="M188.6 142.8c0-.6.8-.6.8 0v1.2h-.8v-1.2" />
          <Use width="100%" height="100%" x={10.6} xlinkHref="#c" />
        </G>
        <Use width="100%" height="100%" y={46.3} xlinkHref="#d" />
        <Use width="100%" height="100%" transform="rotate(-45.2 312.8 180)" xlinkHref="#d" />
      </G>
      <Use width="100%" height="100%" x={45.7} xlinkHref="#d" />
      <Use width="100%" height="100%" transform="matrix(-1 0 0 1 479.8 0)" xlinkHref="#e" />
      <G id="f" fill="#fff">
        <Path
          fill="#039"
      ...
      <Use width="100%" height="100%" y={-26} xlinkHref="#f" />
      <Use width="100%" height="100%" x={-20.8} xlinkHref="#f" />
      <Use width="100%" height="100%" x={20.8} xlinkHref="#f" />
      <Use width="100%" height="100%" y={25.8} xlinkHref="#f" />
    </G>
  </Svg>
)
