            ...
            <View style={styles.authForm}>
                <View style={{ marginBottom: 40, display: "flex", }}>
                    <View style={{ alignItems: "center" }}>
                        <Text style={{ paddingBottom: 5, textAlign: "center", color: "white", fontWeight: "400", fontSize: 15 }} onPress={() => navigation.navigate('Auth')}>Ваш IP</Text>
                        {statusConect === "on" && <Text style={{ paddingBottom: 5, textAlign: "center", color: "white", fontWeight: "700", fontSize: 24 }}>136.117.121.183</Text>}
                        {statusConect === "off" && <Text style={{ paddingBottom: 5, textAlign: "center", color: "white", fontWeight: "700", fontSize: 24 }}>192.0.0.1</Text>}
                        {statusConect === "none" && <Text style={{ paddingBottom: 5, textAlign: "center", color: "white", fontWeight: "700", fontSize: 24 }}>192.0.0.1</Text>}
                        <View style={{ display: "flex", flexDirection: "row", alignItems: "center", }}>
                            {statusConect === "on" &&
                                <Text style={{ paddingBottom: 15, textAlign: "center", color: "white", fontWeight: "700", fontSize: 24 }}>
                                    <Text style={{
                            ...
                            {statusConect === "off" &&
                                <Text style={{ paddingBottom: 15, textAlign: "center", color: "white", fontWeight: "700", fontSize: 24 }}>
                                    <Text style={{ textAlign: "center", color: "white", fontWeight: "600", fontSize: 14, marginRight: 5, alignItems: "center" }} onPress={() => navigation.navigate('Auth')}>
                                        Россия
                                    </Text>
                                </Text>}
                            {statusConect === "none" &&
                                <Text style={{ paddingBottom: 15, textAlign: "center", color: "white", fontWeight: "600", fontSize: 14, marginRight: 5, alignItems: "center" }} onPress={() => navigation.navigate('Auth')}>
                                    Россия
                                </Text>
                            }
                        ...
                        >
                            <View>
                                <View style={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
                                    ...
                                    {statusConect == "on" && <Text style={{ color: "white", marginLeft: 10, fontWeight: "600", fontSize: 15 }}>Подключено</Text>}
                                    {statusConect == "off" && <Text style={{ color: "white", marginLeft: 10, fontWeight: "600", fontSize: 15 }}>Не подключено</Text>}
                                    {statusConect == "none" && <Text style={{ color: "white", marginLeft: 10, fontWeight: "600", fontSize: 15 }}>Нет подключения</Text>}
                                </View>
                                ...
                                >
                                    <View style={{
                                        ...
                                        <View style={{ marginLeft: 14, }}>
                                            ...
                                            <View style={{ display: "flex", flexDirection: "row", fontWeight: "400", fontSize: 13, alignItems: "center" }}>
                                                <Text style={{
                                                    color: "#0F1218",
                                                    paddingBottom: 4,
                                                    paddingTop: 4,
                                                ...
                                                <Text style={{ color: "white", marginLeft: 6, fontWeight: "400", fontSize: 13 }}>136.117.121.183</Text>
                                            </View>
                                        </View>
                                    </View>
                                    <VectorRight color="#636363"></VectorRight>
                                </TouchableOpacity>
                            }
                            {statusConect === "on" &&
                                <TouchableOpacity style={{
